/****************************************************************************
** Meta object code from reading C++ file 'led_controller.h'
**
...
#error "The header file 'led_controller.h' doesn't include <QObject>."
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSLedControllerENDCLASS_t qt_meta_stringdata_CLASSLedControllerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(37, 9),  // "toggleLed"
        QT_MOC_LITERAL(47, 8)   // "ledState"
    },
    "LedController",
    "ledStateChanged",
    "",
...
void LedController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ledStateChanged((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->toggleLed(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (LedController::*)(bool );
            if (_t _q_method = &LedController::ledStateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->ledState(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setLedState(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void LedController::ledStateChanged(bool _t1)
{
